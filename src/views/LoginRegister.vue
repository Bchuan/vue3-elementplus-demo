    ...
    <div class="container" :class="{ 'sign-up-mode': signUpMode }">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img class="image" src="../assets/img/register.svg" />
            </div>
            <div class="panel right-panel">
                <div class="content">
                    <h3>以人为镜，可以明得失，以代码为镜，可以通逻辑</h3>
                    <p>学习编程，让你的生化更有趣</p>
                    <button @click="signUpMode = !signUpMode" class="btn transparent">登录</button>
                </div>
                <img class="image" src="../assets/img/log.svg" />
            </div>
        </div>
    </div>
</template>
...
1、登录的表单运行后，无法输入内容【】
解决：  将  ：model  改为  v-model    即可

2、校验规则有问题，似乎只校验一次
解决：  将  el-form标签的v-model改为:model即可

3、el-select问题：placeholder无效，el-option无效
解决：  将element-plus升级
...
export default {
    ...
    setup() {
        const signUpMode = ref<Boolean>(true);
